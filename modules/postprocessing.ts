...
//
// WebGL only. The effect catalogue it composes lives under ./post (composer,
// pipeline, the standalone passes) and ./post/webgl (the full effect set),
// ported from threejs-scenes/lib/post.
