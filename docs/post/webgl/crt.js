...
export function createCrtPass({ curvature = 0.12, vignette = 0.35, glitch = 0.3 } = {}) {
    const pass = new ShaderPass(CRT_SHADER);
...
export function crtCorrectPointer(ndcX, ndcY, curvature) {
